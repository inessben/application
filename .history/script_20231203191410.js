  ...
  if (event.code === 'Space') {
    switch (textContent.innerText) {
      ...
      default:
        ...
        mainContent.style.overflow = 'scroll'; // Activer le défilement dans le contenu principal
    ...
    }, 500); // 500ms correspond à la durée de la transition dans le style de texte
  }
});